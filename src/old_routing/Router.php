...
class OldRouter {
    ...
    public function addRoute(OldRoute $route) {
    ...
    */
    ...
    private function getRoute(string $url): OldRoute | null {
    ...
    private function validateRouteQuery(array $parameters, OldRoute $route): array {
        $errors = [];
